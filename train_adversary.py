...
def cross_entropy_loss(logits, gt_target , emp1 , emp2):
    """
...
def main(args):
    ...
    if args.output == 'label' :
        ...
        perturbations = torch.argmax(perturbations, dim=1)
    ...
    student = load_model(args.eval_data, num_classes, use_vgg_countermeasure=use_vgg_countermeasure, arch=args.arch)
    num_epochs = 50
    ...
    if args.oracle != 'None':
        ...
        teacher_path = '/kaggle/working/save_path/model'.format(args.eval_data)
...
if __name__ == '__main__':
    ...
    ###############################################
    parser.add_argument('--output', type=str, choices=['vector', 'label'], default='vector')
